...
@Component({
  selector: 'app-form-consolidation-detail',
  templateUrl: './form-consolidation-detail.component.html',
  styleUrls: ['./form-consolidation-detail.component.scss']
})
export class FormConsolidationDetailComponent {
