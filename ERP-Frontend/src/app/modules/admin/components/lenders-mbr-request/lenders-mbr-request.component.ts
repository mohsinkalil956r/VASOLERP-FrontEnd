...
@Component({
  selector: 'app-lenders-mbr-request',
  templateUrl: './lenders-mbr-request.component.html',
  styleUrls: ['./lenders-mbr-request.component.scss']
})
export class LendersMbrRequestComponent {
